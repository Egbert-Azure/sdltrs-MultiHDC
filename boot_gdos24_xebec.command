...
# a hard disk attached via the Xebec S1410 controller emulation
...
#
# This is the plain "just play" launcher: no logging, no port tracing.
# Use boot_gdos24_xebec_debug.command when a full I/O trace to logs/ is
# needed for investigating a problem.
#
